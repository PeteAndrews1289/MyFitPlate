...
public enum ProductAnalytics {
    ...
    public enum Event: String, CaseIterable, Sendable {
        ...
        case setupChecklistViewed = "setup_checklist_viewed"
        case setupChecklistAction = "setup_checklist_action"
        case setupChecklistDismissed = "setup_checklist_dismissed"
        case adaptiveTargetsOfferViewed = "adaptive_targets_offer_viewed"
        case adaptiveTargetsOfferOpened = "adaptive_targets_offer_opened"
        case adaptiveTargetsOfferDeclined = "adaptive_targets_offer_declined"
