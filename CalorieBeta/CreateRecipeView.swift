    ...
    private func saveRecipe() {
        ...
        Task {
            if creationMode == .ai {
                ...
                let recipe = Recipe(name: recipeName.trimmingCharacters(in: .whitespacesAndNewlines), ingredients: ingredientNames, instructions: instructionSteps, nutrition: totalNutrition)
