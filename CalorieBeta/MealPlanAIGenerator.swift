...
@MainActor
struct MealPlanAIGenerator {
    
    // MARK: - Single Meal Regeneration
    func regenerateSingleMeal(for day: MealPlanDay, mealToReplace: PlannedMeal, goals: GoalSettings, preferredFoods: [String], preferredCuisines: [String], preferredSnacks: [String], retryCount: Int = 1) async -> PlannedMeal? {
    ...
    func generateWeekPlan(goals: GoalSettings, preferredFoods: [String], preferredCuisines: [String], preferredSnacks: [String]) async -> [MealPlanDay] {
